...
public class StealthArt : NinjaModCard
{
    ...
    public override List<(string, string)>? Localization => Lang.Zh
        ? new CardLoc("隐身法", $"获得 {Vigor} 点活力，并进入隐身状态（敌人无法攻击你，直到你发动攻击）。")
        : new CardLoc("Stealth Art", $"Gain {Vigor} Vigor and become Stealthed (enemies can't attack you until you attack).");
}
