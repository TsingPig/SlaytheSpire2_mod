...
public class DemonFlameBurst : NinjaModCard
{
    ...
    public override List<(string, string)>? Localization => Lang.Zh
        ? new CardLoc("火忍：火魔爆", "造成 12 点伤害，然后引爆目标身上的所有燃烧（造成燃烧层数 2 倍的无法格挡伤害并移除）。")
        : new CardLoc("Fire Ninjutsu: Demon Flame Burst", "Deal 12 damage, then ignite all Burning on the target (deal twice Burning as unblockable damage, then remove it).");
}
