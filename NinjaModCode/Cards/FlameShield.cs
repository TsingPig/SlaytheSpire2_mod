...
public class FlameShield : NinjaModCard
{
    ...
    public override List<(string, string)>? Localization => Lang.Zh
        ? new CardLoc("火忍：火盾", "获得火盾：每当你受到攻击时，对攻击者施加 3 层燃烧。")
        : new CardLoc("Fire Ninjutsu: Flame Shield", "Gain Flame Shield: whenever you are attacked, apply 3 Burning to the attacker.");
}
