...
| 九字护身法 | KujiProtection | Uncommon | 2(1) | Power | BaseKujiProtection=1<br>ConstResist=2 | 获得 2 层【抵挡】；每回合开始额外获得当前抵挡层数 2 倍的格挡。 |
...
| 火忍：离火符 | Lihuo | Uncommon | 0 | Skill | BaseBurning=6<br>UpgradeBurning=9 | 给予目标 6(9) 层【燃烧】。 |
...
| 武藏：迅光三角剑 | MusashiSwiftTriangle | Uncommon | 1 | Skill | BaseDamage=11<br>UpgradeDamage=15<br>BaseDex=1<br>UpgradeDex=2 | 造成 11(15) 点伤害，获得 1(2) 点敏捷。【武藏】牌。 |
...
| 追魂 | SoulChase | Uncommon | 3 | Skill | BaseSoulChaseBleed=1<br>BaseCards=2<br>UpgradeCards=3<br>ConstKunaiDamage=5 | 消耗牌堆中每有一张【飞刀】，对目标造成其伤害；若未被完全格挡，施加 1 层【流血】。若击杀目标，抽 2(3) 张牌。 |
...
| 八咫镜 | YataMirror | Uncommon | 1 | Power | BaseBlock=3<br>UpgradeBlock=4 | 每回合开始时，获得 3(4) 点格挡。 |
...
| 火忍：锻火刺 | ForgeFlameThrust | Common | 1 | Attack | BaseDamage=5<br>UpgradeDamage=8<br>BaseBurning=4<br>UpgradeBurning=5 | 造成 5(8) 点伤害，附加 4(5) 层【燃烧】。 |
...
| 武士刀法 | KatanaArt | Common | 2 | Attack | BaseDamage=5<br>BaseRepeat=2<br>UpgradeRepeat=3 | 对所有敌人造成 5 点伤害，共 2(3) 次。 |
...
| 武藏：刺 | MusashiThrust | Common | 0 | Attack | BaseDamage=7<br>UpgradeDamage=11<br>ConstBleed=2 | 造成 7(11) 点伤害，附加 2 层【流血】。【武藏】牌。 |
...
| 土忍：聚石刺 | StoneGatherThrust | Common | 1 | Attack | BaseDamage=3<br>UpgradeDamage=5<br>BaseBlock=6<br>UpgradeBlock=9 | 造成 3(5) 点伤害，获得 6(9) 点格挡。 |
